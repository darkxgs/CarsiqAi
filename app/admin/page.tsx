...
import { OilProductsManager } from "@/components/admin/OilProductsManager"
    ...
    <div className="h-full p-8 space-y-8">
      ...
      <Tabs defaultValue="analytics" className="space-y-6">
        <TabsList className="grid w-full grid-cols-3">
          ...
          <TabsTrigger value="oil-products">منتجات الزيوت</TabsTrigger>
        ...
        <TabsContent value="oil-products">
          <OilProductsManager />
        </TabsContent>
