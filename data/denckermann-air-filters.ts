...
export function findAirFilterByVehicle(make: string, model: string): string | null {
  ...
  if (!make || !model || typeof make !== 'string' || typeof model !== 'string') {
    console.warn('Invalid parameters provided to findAirFilterByVehicle', { make, model });
    return null;
  }
...
export function searchAirFiltersByVehicleName(searchTerm: string): Array<{filterNumber: string, vehicle: string, brands: string[]}> {
  ...
  if (!searchTerm || typeof searchTerm !== 'string') {
    console.warn('Invalid searchTerm provided to searchAirFiltersByVehicleName', { searchTerm });
    return results;
  }
